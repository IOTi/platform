...
addGroup 'IOTi' ''
addUser 'IOTi' '' 'IOTi' 'IOTi user-daemon' '/bin/false'
...
wget https://raw.githubusercontent.com/IOTi/platform/master/resources/template.service
...
wget https://raw.githubusercontent.com/IOTi/platform/master/resources/node_red_settings.js
mv node_red_settings.js ~/.node-red/settings.js

wget https://raw.githubusercontent.com/IOTi/platform/master/resources/IOTi_flow.json
mv IOTi_flow.json ~/.node-red/IOTi_flow.json
##### ================================================ #####
